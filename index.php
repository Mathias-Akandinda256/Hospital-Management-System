        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:black;  max-width: auto; max-height: auto; white-space: nowrap;">GOD HEALS MEDICAL CENTER</div>
              ...
              <div class="text-sec">
                ...
                <ul class="row">
                  <li class="col-sm-6">
                    ...
                    <p>Registered clients to our hospital will be given immediate attention in case of any emergency. Patients will be reached to in their home places, picked up by the hospital amblance without any payments. This will be done to patients who have registered with the hospital management </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>A team of doctors is ready to provide to you any services you need from God Heals Medical Center</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Clients make online appointment with the doctor and can be given a schedule to meet their doctor </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>God Heals Medical Center provides free medication and conselling every Tuesday </p>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>We have doctors who specializes in eye and vision care.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>An operating theater (also known as an operating room (OR), operating suite, or operation suite) is a facility within a hospital where surgical operations </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>ICU teams are multi-disciplinary, made up of highly skilled intensive care nurses, doctors and specialists trained in providing critical care for patients with </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>The outcome measure was the percentage of doctors agreeing with the statement "My experience at medical school has prepared me well for the jobs</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>In general, treatment for heart disease usually includes: Lifestyle changes. You can lower your risk of heart disease by eating a low-fat and low-sodium diet, getting at least 30 minutes of moderate exercise on most days of the week, quitting smoking, and limiting alcohol intake. Medications</p>
                </div>
              </article>
            </div>
